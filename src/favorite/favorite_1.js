...
function Favorite_1(props){
    ...
    if(step===1){
        ...
        return(
            <Favorite_3 control_change={props.control_change} result_data_change={props.result_data_change} cancle_giphodata={props.cancle_giphodata} select_gipho_data2={value} result_change={props.result_change}/>
        )
    }
