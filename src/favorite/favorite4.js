  ...
  render() {
    return (
      <div className="Favorite_4_main_div">
          ...
          <div className="Favorite_4_main_div_main">
              <div className="Favorite_4_main_div_main1">
                  <div className="Favorite_4_main_div_main1_1">
                      <div className="Favorite_4_main_div_main1_1_title" >
                          <span id="gipho_name1">쾌적한 지역</span><span id="gipho_name2">에서 살고 싶어요!.</span>
                      </div>
                      <div className="Favorite_4_list" draggable="true" onDragEnd={()=>{this.dragend2()}}>
                  ...
                  <div className="Favorite_4_main_div_main1_2">
                      <div className="Favorite_4_main_div_main1_1_title">
                          <span id="gipho_name1">교육열</span><span id="gipho_name2">이 높은 지역에서 살고 싶어요!.</span>
                      </div>
                  ...
                  <div className="Favorite_4_main_div_main1_3">
                      <div className="Favorite_4_main_div_main1_1_title">
                          <span id="gipho_name1">안전한 지역</span><span id="gipho_name2">에서 살고 싶어요!.</span>
                      </div>
                      <div className="Favorite_4_list">
              ...
              <div className="Favorite_4_main_div_main2">
                <div className="Favorite_4_main_div_main2_1">
                    <div className="Favorite_4_main_div_main1_1_title">
                    <span id="gipho_name2">이런 &nbsp;</span><span id="gipho_name1">이웃</span><span id="gipho_name2">있으면 좋겠어요!.</span>
                      </div>
                      <div className="Favorite_4_list">
                ...
                <div className="Favorite_4_main_div_main2_2">
                    <div className="Favorite_4_main_div_main1_1_title">
                          <span id="gipho_name1">취업/창업</span><span id="gipho_name2">이 활발한 지역이면 좋겠어요!.</span>
                      </div>
                      <div className="Favorite_4_list">
                ...
                <div className="Favorite_4_main_div_main2_3">
                      <div className="Favorite_4_main_div_main1_1_title">
                        <span id="gipho_name2">이런 &nbsp;</span><span id="gipho_name1">특성</span><span id="gipho_name2">이 있으면 좋겠어요!.</span>
                      </div>
                      <div className="Favorite_4_list">
          ...
          <div className="gipho_selecting_div_title">
              * 위의 지표를 드래그하여 순위대로 아래의 블럭에 두시면 됩니다.
          </div>
          <div className="gipho_selecting_div">
              <div className="gipho_selecting_div1_3">
                  ...
                  <div className="gipho_selecting_list">
                      2
                  </div>
                  <div className="gipho_selecting_list">
                      3
          ...
          <div className="gipho_selecting_div_button">
              <button id="gipho_button1">
                  뒤로가기
              </button>
              <button id="gipho_button2">
                  결정 완료
              </button>
          </div>
      </div>
