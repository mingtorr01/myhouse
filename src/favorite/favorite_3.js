    ...
    <div className="Favorite_3_main">
      <div className="Favorite_3_main_div">
        <div className="favorite_title_div2">
          ...
          <p>3. 지표를 선택하세요.</p>
          <button id="cancle_step" onClick={()=>{this.props.favorite_div_bool_change(false); this.props.cancle_select_gipho_data_change();}}></button>
        </div>
      ...
      <div className="gipho" key={this.props.select_gipho_data}>
        ...
        <button id="gipho_select_button" onClick={() => {this.props.result_change(this.props.step); this.setState({value:[]})}}>
          선택 완료
        </button>
      </div>
    </div>
