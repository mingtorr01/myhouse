  ...
  return (
    <div className="keyword_main">
      ...
      <div className="realtime_visitor">
        ...
        <button className="realtime_visitor_button" onClick={realtime_onclick_true}></button>
      </div>
    </div>
  );
}
...
function Realtime_visitor(props) {
  return (
    <div className="show_realtime_visitor">
      ...
      <button className="show_realtime_visitor_button" onClick={props.realtime_onclick_false}></button>
      <div className="show_realtime_visitor_main">
        ...
        <div className="show_realtime_visitor_main_end">2021.02.18 20:18 기준</div>
      </div>
    </div>
  );
}
