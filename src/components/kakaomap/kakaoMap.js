...
const MapContainer = (props) => {
  ...
  useEffect(() => {
    if (school_data !== null) {
      ...
      var linePath = [new kakao.maps.LatLng(school_data.marker_location.lat, school_data.marker_location.lon), new kakao.maps.LatLng(school_data.location.lat, school_data.location.lon)];
